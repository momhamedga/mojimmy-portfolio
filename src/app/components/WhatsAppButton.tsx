...
export default function WhatsAppButton() {
  ...
  // حركة مغناطيسية ناعمة جداً، متتبّعة بـ rAF لمنع Layout Thrash عند كل حركة ماوس
  const { ref: containerRef, x: mouseX, y: mouseY, handleMouseMove, reset } = useMagneticPointer(0.2, { stiffness: 60, damping: 15 });
    ...
    <div className="fixed bottom-8 left-8 z-1000 hidden md:block group">
      ...
      >
        ...
        <motion.a
          ...
          className="relative z-10 w-14 h-14 bg-linear-to-tr from-[#128C7E] to-[#25D366] rounded-full flex items-center justify-center shadow-[0_10px_25px_rgba(37,211,102,0.3)] border border-white/10"
